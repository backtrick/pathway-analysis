...
def moduleMaker(nModules, nNodes = 5271, moduleSize = 10, network = '/Users/patrick/Documents/CHBE194/G_matrix_hsa_06182020.p'):
...
def pathfinder(biomolecule_modules, biomoleculesAndPathways, human_kegg = '/Users/patrick/Documents/CHBE194/Human_KEGG_cytoscape_06182020.p'):
...
def cytoscape(unique_tissues, 
  ...
  Args:
    ...
    for tissue in unique_tissues:
        ...
        tissue_network.to_csv('/Users/patrick/Documents/CHBE194/Final_Project_Files/outputs/'+tissue_file_name+version+'_network.csv', index=False)
        cytoscape_attributes.to_csv('/Users/patrick/Documents/CHBE194/Final_Project_Files/outputs/'+tissue_file_name+version+'_attributes.csv')
